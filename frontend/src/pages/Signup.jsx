...
const Signup = () => {
  ...
  const handleSignup = (e) => {
    ...
    toast({
      ...
      description: 'Welcome to Easy Scan PDF!',
    });
        ...
        <CardContent>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button variant="outline" onClick={() => toast({ title: 'Google signup', description: 'This is a demo' })}>
              ...
              <Button variant="outline" onClick={() => toast({ title: 'Microsoft signup', description: 'This is a demo' })}>
