        ...
        <CardContent>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button variant="outline" onClick={() => toast({ title: 'Google login', description: 'This is a demo' })}>
              ...
              <Button variant="outline" onClick={() => toast({ title: 'Microsoft login', description: 'This is a demo' })}>
