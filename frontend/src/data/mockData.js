...
export const pdfTools = [
  ...
  },
  {
    id: 'organize-pdf',
    name: 'Organize PDF',
    description: 'Sort pages of your PDF file however you like. Delete PDF pages or add PDF pages to your document at any convenience.',
    icon: 'organize',
    color: '#F4511E',
    category: ['all', 'organize'],
    route: '/organize-pdf'
...
export const pricingPlans = [
  ...
  },
  {
    ...
    originalPrice: 9,
    period: '/month',
    billingNote: 'Billed annually at $60',
    discount: '42% off',
    features: [
      'Unlimited processing',
      'All tools access',
      'Up to 500 pages per file',
      'File size limit: 4GB',
      'Ad-free experience',
      'Web, Mobile & Desktop',
      'Digital signatures',
